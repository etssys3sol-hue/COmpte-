  ...
  return (
    <div className="p-6 max-w-[1700px] mx-auto space-y-6">
      <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-2xl p-6">
        <h1 className="text-2xl font-bold mb-2 text-slate-900 dark:text-slate-100">{user?.establishmentName}</h1>
        <p className="text-slate-500 dark:text-slate-400">Code d'identification : <span className="font-mono text-blue-400">{user?.establishmentCode}</span></p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-2xl p-6">
          <div className="flex items-center gap-3 mb-4">
            ...
            <h2 className="font-medium text-slate-700 dark:text-slate-300">Total Enseignants</h2>
          </div>
        ...
        <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-2xl p-6">
          <div className="flex items-center gap-3 mb-4">
            ...
            <h2 className="font-medium text-slate-700 dark:text-slate-300">En cours</h2>
          </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mt-8">
        <Link to="/espace/grand-tableau" className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 hover:border-blue-500/50 p-6 rounded-2xl transition-all group block">
          ...
          <p className="text-sm text-slate-500 dark:text-slate-400">Saisie en masse des données de tous les enseignants.</p>
        </Link>
        
        <Link to="/espace/enseignants" className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 hover:border-blue-500/50 p-6 rounded-2xl transition-all group block">
          ...
          <p className="text-sm text-slate-500 dark:text-slate-400">Consultation et saisie détaillée fiche par fiche.</p>
        </Link>

        <Link to="/espace/referentiels" className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 hover:border-blue-500/50 p-6 rounded-2xl transition-all group block">
          ...
          <p className="text-sm text-slate-500 dark:text-slate-400">Consultez vos métiers, filières et disciplines.</p>
        </Link>
      </div>
    </div>
  );
